      ...
      <div className="max-w-sm bg-white shadow rounded p-6">
        ...
        <div className="mt-6 flex">
          <div className="w-10 flex flex-col items-center">
            <Image className="h-10 rounded-full" src="./barmond.jpg" />
            <div className="pt-4">
              <svg
                width={1}
                height={40}
          ...
          <div className="pl-3">
            ...
            <p className="pt-4 text-sm leading-4 text-gray-600">
              Project Management{" "}
              <span className="text-green-600">Value $4.5M </span>
            </p>
          </div>
        </div>
        <div className="mt-6 flex">
          <div className="w-10 flex flex-col items-center">
            <Image className="h-10 rounded-full" src="./Oak_st.jpg" />
            <div className="pt-4">
              <svg
                width={1}
                height={40}
          ...
          <div className="pl-3">
            ...
            <p className="pt-4 text-sm leading-4 text-gray-600">
              Project Management{" "}
              <span className="text-green-600">Value $14.2M </span>
            </p>
          </div>
        </div>
        <div className="mt-6 flex">
          <div className="w-10 flex flex-col items-center">
            <Image className="h-10 rounded-full" src="./shepperd.jpg" />
            <div className="pt-4">
              <svg
                width={1}
                height={40}
          ...
          <div className="pl-3">
            ...
            <p className="pt-4 text-sm leading-4 text-gray-600">
              Project Management{" "}
              <span className="text-green-600">Value $3.5M </span>
            </p>
          </div>
        </div>
      </div>
