    ...
    <div className>
      <div className="flex flex-col items-start lg:items-center justify-between ">
        <div className="md:auto lg:w-auto md:mx-2 flex justify-center items-center">
          <h1 className="text-xl md:text-xl xl:text-xl font-semibold pl-4">Current <span className="text-blue-700">Teammates</span>.</h1>
        </div>
           ...
           className="swiper mySwiper">
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5  rounded-xl ">
                <div className="flex flex-col  space-y-5">
                  <div className="rounded-t-xl max-h-36 group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl max-h-36 " src="../Mark_Zheng.jpg" alt="Mark Zheng" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">Mark Zheng</p>
              ...
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5 rounded-xl ">
                <div className="flex flex-col  space-y-4">
                  <div className="rounded-t-xl max-h-36 group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl max-h-36 " src="Tony_lin.jpg" alt="Tony Lin" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">Tony Lin</p>
                    <button className="mt-6 hover:-translate-y-1 transition duration-500 ease-in-out flex justify-start items-center space-x-3">
              ...
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5  rounded-xl ">
                <div className="flex flex-col  space-y-4">
                  <div className="rounded-t-xl max-h-36 group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl max-h-36 " src="../Dora_Wu.jpg" alt="Dora Wu" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">Dora Wu</p>
                    <button className="mt-6 hover:-translate-y-1 transition duration-500 ease-in-out flex justify-start items-center space-x-3">
