                ...
                <div className="bg-white dark:bg-gray-800 shadow rounded">
                    <div className="relative">
                        ...
                        <div className="inset-0 m-auto w-24 h-24 absolute bottom-0 -mb-12 xl:ml-10 rounded border-2 shadow border-white">
                            <img className="w-full h-full overflow-hidden object-cover rounded" src="./stanford_siu.jpg" alt />
                        </div>
                    </div>
                        ...
                        <div className="pt-3 xl:pt-5 flex flex-col xl:flex-row items-start xl:items-center justify-between">
                            <div className="xl:pr-16 w-full xl:w-2/3">
                                <div className="text-center xl:text-left mb-3 xl:mb-0 flex flex-col xl:flex-row items-center justify-between xl:justify-start">
                                    <h2 className="mb-3 xl:mb-0 xl:mr-4 text-2xl text-gray-800 dark:text-gray-100 font-medium tracking-normal">Stanford Siu</h2>
                                    <div className="text-sm bg-indigo-700 dark:bg-indigo-600 text-white px-5 py-1 font-normal rounded-full">Confirmed</div>
                                </div>
                                <p className="text-center xl:text-left mt-2 text-sm tracking-normal text-gray-600 dark:text-gray-400 leading-5">Happy Product Manager | Crypto Enthusiast | Technology Driven</p>
                            </div>
                            <div className="xl:px-10 xl:border-l xl:border-r w-full py-5 flex items-start justify-center xl:w-1/3">
                                <div className="mr-6 xl:mr-10">
                                    <h2 className="text-gray-600 dark:text-gray-400 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center">18</h2>
                                    <p className="text-gray-800 dark:text-gray-100 text-sm xl:text-md leading-5">Current Projects</p>
                                </div>
                                <div className="mr-6 xl:mr-10">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-800 dark:text-gray-100 text-sm xl:text-md leading-5">Approved Connection</p>
                                </div>
                            </div>
