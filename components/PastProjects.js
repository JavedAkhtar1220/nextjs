    ...
    <div >
      <div className="flex p-5 flex-col items-start lg:items-center justify-between ">
        <div className="md:auto lg:w-auto md:mx-2 flex justify-center items-center">
          <h1 className="text-2xl md:text-2xl xl:text-2xl pt-5 font-semibold pl-4">Past <span className="text-blue-700">Projects</span>.</h1>
        </div>
           ...
           className="swiper mySwiper">
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5  rounded-xl ">
                <div className="flex flex-col  space-y-5">
                  <div className="rounded-t-xl  group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl  " src="dunfell.jpg" alt="man" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    <p className="text-sm leading-none text-gray-600">3 Beds, 3 Baths </p>
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">700 Dunfell St, Vancouver, BC</p>
                    <p className="mt-3 text-base font-semibold leading-none text-green-600">Value $3.8M</p>
                    <button className="mt-6 hover:-translate-y-1 transition duration-500 ease-in-out flex justify-start items-center space-x-3">
                      <p className="text-sm leading-none text-blue-700">See Details</p>
                      <div className="w-4 ">
              ...
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5 rounded-xl ">
                <div className="flex flex-col  space-y-4">
                  <div className="rounded-t-xl  group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl  " src="../barmond.jpg" alt="Barmond Ave" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    <p className="text-sm leading-none text-gray-600">5 Beds, 5 Baths </p>
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">3271 Barmond Ave</p>
                    <p className="mt-3 text-base font-semibold leading-none text-green-600">Value $6.7M</p>
                    <button className="mt-6 hover:-translate-y-1 transition duration-500 ease-in-out flex justify-start items-center space-x-3">
                      <p className="text-sm leading-none text-blue-700">See Details</p>
                      <div className="w-4 ">
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/content_9_svg-2.svg" alt="arrow" />
              ...
              <SwiperSlide className="swiper-slide shadow-xl mb-10 mt-5  rounded-xl ">
                <div className="flex flex-col  space-y-4">
                  <div className="rounded-t-xl  group cursor-pointer relative flex justify-center items-center">
                    <img className="rounded-t-xl  " src="../shepperd.jpg" alt="Sheppered St" />
                  </div>
                  <div className="px-4 py-6 rounded-b-xl w-full flex justify-between  flex-col items-start ">
                    <p className="text-sm leading-none text-gray-600">2 Beds, 2 Baths</p>
                    <p className="mt-3 text-base font-semibold leading-none text-gray-800">4745 Shepperd St, Richmond, BC</p>
                    <p className="mt-3 text-base font-semibold leading-none text-green-600">Value $2.3M</p>
                    <button className="mt-6 hover:-translate-y-1 transition duration-500 ease-in-out flex justify-start items-center space-x-3">
                      <p className="text-sm leading-none text-blue-700">See Details</p>
                      <div className="w-4 ">
                        <img src="https://tuk-cdn.s3.amazonaws.com/can-uploader/content_9_svg-2.svg" alt="arrow" />
