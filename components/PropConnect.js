  ...
  <div className="lg:max-w-[1440px] md:max-w-[744px] max-w-[375px] w-full mx-auto py-12 lg:px-20 md:px-6 px-4 bg-white">
    ...
    <div className="pl-5 py-5">
                            ...
                            <div className="flex justify-center items-center py-5">
                                <img src="../Stanford_Siu.jpg" className="w-12 h-12 rounded-full" />
                                <div className="ml-4">
                            ...
                            <div className="flex justify-center items-center lg:mt-0 mt-4">
                                <a href="javascript:void(0)">
                                    {" "}
                                    <button className="py-2 px-6 bg-indigo-700 text-white text-sm mr-4 focus:outline-none">Chat With Stanford</button>
                                </a>
                                <a href="javascript:void(0)">
                                    {" "}
                                    <button className="py-2 px-6 bg-transparent border border-indigo-700 text-indigo-700 text-sm focus:outline-none">Call Stanford</button>
                                </a>
                            </div>
    ...
    <div className="flex flex-col items-start justify-center lg:flex-row gap-x-6"> 
      <div className="lg:max-w-2/3 w-full relative">
        <iframe src="https://www.google.com/maps/embed/v1/place?q=place_id:ChIJNzPygqgKhlQRLWCmeX7PMU4&key=AIzaSyC181FbUhddAYgHPYvbdjpGjDCT5KYvwAw" width="100%" height={496} style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
      </div>
