                                ...
                                <div className="w-full grid grid-cols-2 md:grid-cols-2 lg:grid-cols-2 2xl:grid-cols-4 justify-items-start items-start gap-4 md:gap-x-6 lg:gap-x-6 gap-y-6">
                                    ...
                                    <h2>Wall Tile</h2>
                                        ...
                                        <div className="flex flex-col justify-center space-y-2">
                                            <p className="w-28 xl:w-auto text-base font-medium leading-normal text-center text-gray-800">Whisper Grey</p>
                                    ...
                                    <h2>Floor Tile</h2>
                                        ...
                                        <div className="flex flex-col space-y-2">
                                            <p className="w-28 xl:w-auto text-base font-medium leading-normal text-center text-gray-800">Whisper White</p>
                                            <p className="text-xs justify-center">Dongpeng</p>
                                        </div>
                                    </div>
                                    <div className="flex justify-center space-y-3 items-center flex-col">
                                    <h2>Cabbinet</h2>
                                        ...
                                        <div className="flex flex-col space-y-2">
                                            <p className="w-28 xl:w-auto text-base font-medium leading-normal text-center text-gray-800">Grey</p>
                                    ...
                                    <h2>Counter Top</h2>
                                        ...
                                        <div className="flex flex-col space-y-2">
                                            <p className="w-28 xl:w-auto text-base font-medium leading-normal text-center text-gray-800">Blizzard Grey</p>
