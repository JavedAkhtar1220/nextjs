            ...
            <div className="pt-3 xl:pt-5 flex flex-col xl:flex-row items-start xl:items-center justify-between">
              <div className="xl:pr-16 w-full xl:w-2/3">
                ...
                <div className="text-center xl:text-left mb-3 xl:mb-0 flex flex-col xl:flex-row mt-10 items-center justify-between xl:justify-start">
                  <h2 className="mb-3 xl:mb-0 xl:mr-4 text-2xl text-gray-600 dark:text-gray-100 font-medium tracking-normal">
                    8600 Francis Rd, Richmond, BC{" "}
                  </h2>

                  <div className="flex w-1/3 justify-center text-sm bg-green-700 dark:bg-green-600 text-white px-4 py-2 font-normal rounded">
                    For Sale
                  </div>
                </div>
                <h1 className="mb-3 xl:mb-0 xl:mr-4 text-3xl font-extrabold text-gray-800 dark:text-gray-100 tracking-normal">
                  Mason Estate
                </h1>
                <p>
                  <div className="mt-6 flex items-center justify-start">
                    <div className="w-8 flex flex-col items-center">
                      <Image className="h-8 rounded-full" src="../m_logo.jpg" />
                    </div>
                ...
                <p>
                  <div className="mt-6 flex items-center justify-start">
                    <div className="w-8 flex flex-col items-center">
                      <Image className="h-8 rounded-full" src="../eric.jpg" />
                    </div>
                    <div className="pl-3 justify-center items-center text-sm font-semibold leading-normal text-gray-800">
              ...
              <div className="xl:px-10 xl:border-l xl:border-r w-full py-5 flex items-start justify-center xl:w-1/3">
                <div className="mr-6 xl:mr-10">
                  <h2 className="text-green-600 dark:text-green-600 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center">
                    $1.27M
                  </h2>
                  <p className="text-gray-800 dark:text-gray-100 text-sm xl:text-md leading-5">
                    Asking
                  </p>
                </div>
                <div className="mr-6 xl:mr-10">
                  <h2 className="text-gray-700 dark:text-gray-700 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center">
                    1-4
                  </h2>
                  <p className="text-gray-800 dark:text-gray-100 text-sm xl:text-md leading-5">
                    Bedrooms
                ...
                <div>
                  <h2 className="text-red-400 dark:text-red-400 font-bold text-xl xl:text-2xl leading-6 mb-2 text-center">
                    18
                  </h2>
                  <p className="text-gray-800 dark:text-gray-100 text-sm xl:text-md leading-5">
                    Units
                ...
                <div className="flex items-center justify-center xl:justify-start mt-1 md:mt-0 mb-5 md:mb-0">
                  <div className="flex items-center justify-center py-8 px-4">
                    <div className="md:w-64 rounded shadow-lg p-5 bg-indigo-700">
                      ...
                      <a
                        target="_blank"
                        href="https://www.masonestates.ca/homes.html"
                        rel="noreferrer"
                      >
