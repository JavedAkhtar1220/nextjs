function Team() {
    return (
<div className="">
 <div className="p-8 justify-center bg-white dark:bg-gray-800 rounded-lg shadow">
    ...
    <div className="flex items-center flex-col md:flex-row justify-center">
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img alt="profil" src="./Tony_lin.jpg" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                </a>
            </div>
            <div className="text-center">
                ...
                VP of Project Data + Analytics at Admiral Operations Ltd.
                </p>
            </div>
        ...
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img alt="profil" src="./Mark_Zheng.jpg" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                </a>
            </div>
            <div className="text-center">
                <p className="text-2xl text-gray-800 dark:text-white">
                ...
                <p className="text-md text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light">
                Admiral Operations - Operations Manager
                </p>
            </div>
            <div className="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between">
                <a href="#">
        ...
        <div className="p-4">
            <div className="text-center mb-4 opacity-90">
                <a href="#" className="block relative">
                    <img alt="profil" src="./Dora_Wu.jpg" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                </a>
            </div>
            <div className="text-center">
                <p className="text-2xl text-gray-800 dark:text-white">
                ...
                <p className="text-md text-gray-500 dark:text-gray-400 max-w-xs py-4 font-light">
                    Admiral Operations Customer relations
                </p>
            </div>
            <div className="pt-8 flex border-t border-gray-200 w-44 mx-auto text-gray-500 items-center justify-between">
                <a href="#">
