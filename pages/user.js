...
<div className="items-center justify-center">
   ...
   <div className="p-4">
                     ...
                     <img alt="profil" src="./stanford_siu.jpg" className="mx-auto object-cover rounded-full h-40 w-40 "/>
                      </a>
                       </div>
                     <div className="text-center justify-center">
                      ...
                      <p className="text-md text-gray-500 dark:text-gray-400 py-4 font-light">
                       Stanford Siu,  Real Estate Development + Construction Project Manager | Technology + Progress Driven | Contribute to Crypto Adoption
                      </p>
                </div>
            ...
            <Team />
            {/* Footer */}
             <Footer classNameName="flex items-center"/>
