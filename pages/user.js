    ...
    <div className="items-center justify-center">
      ...
      <div className="p-4">
        ...
        <div className="text-center justify-center">
          <p className="text-2xl text-gray-800 dark:text-white">Stanford Siu</p>
          <p className="text-xl text-gray-500 dark:text-gray-200 font-light">
            Developer
          </p>
          <p className="text-md text-gray-500 dark:text-gray-400 py-4 font-light">
            Stanford Siu, Real Estate Development + Construction Project Manager
            | Technology + Progress Driven | Contribute to Crypto Adoption
          </p>
        </div>
